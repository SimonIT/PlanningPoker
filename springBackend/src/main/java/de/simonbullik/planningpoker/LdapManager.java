...
public class LdapManager {
    ...
    private static String defaultUser = "CN=Simon Bullik,OU=User,OU=HEC,OU=NEUSTA,DC=intern,DC=neusta,DC=de"; // Fill in the distinguished name for a default user to fetch all data
